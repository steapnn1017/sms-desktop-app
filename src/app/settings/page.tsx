        ...
        <div className="app-card p-5 space-y-4">
            ...
            <div className="flex items-center gap-2">
                ...
                <div className={cn('ml-auto flex items-center gap-1.5 text-xs', statusColor)}>
                    ...
                    {status === 'unknown' && <WifiOff className="w-3 h-3" />}
                    <span>
            ...
            <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-4 flex gap-3">
                ...
                <div className="space-y-1">
                    ...
                    <ol className="text-xs text-[#525252] space-y-0.5 list-decimal list-inside">
                        <li>Nainstalujte aplikaci <strong className="text-[#a3a3a3]">SMS Gateway</strong> na Android telefon (z GitHub: capcom6/android-sms-gateway)</li>
                        <li>Vytvořte účet na <strong className="text-[#a3a3a3]">app.sms-gate.app</strong></li>
                        <li>V aplikaci aktivujte Cloud relay a přihlaste se ke svému účtu</li>
                        <li>Zadejte přihlašovací údaje níže pro každého zaměstnance</li>
                    </ol>
                    <p className="text-xs text-blue-300 mt-2">
                        Při odesílání SMS se automaticky použije ta gateway, která je zrovna online (Gateway 1 má prioritu).
                    </p>
                    <button
